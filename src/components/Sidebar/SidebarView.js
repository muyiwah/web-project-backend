...
import {
  ...
  ImportContactsIcon as ImportContactsIcon,
  FilterNone as UIElementsIcon,
  SubscriptionsIcon as SubscriptionsIcon,
...
const structure = [
  ...
  { id: 1, label: 'Courses', link: '/app/typography', icon: <ImportContactsIcon /> },
  { id: 2, label: 'Users', link: '/app/tables', icon: <SubscriptionsIcon /> },
